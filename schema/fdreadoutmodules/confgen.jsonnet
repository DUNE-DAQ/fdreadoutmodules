...
local cs = {
    ...
    fdreadoutmodules: s.record("fdreadoutmodules", [
    ...
    fdreadoutmodules_gen: s.record("fdreadoutmodules_gen", [
        s.field("boot", daqconf.boot, default=daqconf.boot, doc="Boot parameters"),
        s.field("fdreadoutmodules", self.fdreadoutmodules, default=self.fdreadoutmodules, doc="fdreadoutmodules parameters"),
    ]),
};
